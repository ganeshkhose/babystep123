...
export const ProductFilters: React.FC<ProductFiltersProps> = ({
  ...
  return (
    <div className="w-full bg-white/95 backdrop-blur-md rounded-2xl sm:rounded-3xl lg:rounded-full px-2.5 sm:px-4 lg:px-5 py-1.5 sm:py-2 border border-brand-baby-blue/30 shadow-[0_6px_24px_rgb(0,0,0,0.06)] text-left transition-all duration-200">
      ...
      <div className="flex items-center gap-2.5 lg:hidden w-full">
        ...
        {/* Full Search Bar - Seamless White (No inner circular box) */}
      ...
      {/* 2. DESKTOP VIEW (Always Single Line, Unchanged, Visible on lg+) */}
      <div className="hidden lg:flex items-center justify-between gap-2.5">
        {/* Brand Logo */}
        <div className="flex items-center shrink-0 mr-4 xl:mr-6">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <Link
            ...
            className={`group flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-bold transition-all duration-200 border-2 shadow-xs focus:outline-none ${
              isBagActive
              ...
              <span
                className={`inline-flex items-center justify-center min-w-[18px] h-[18px] px-1 text-[10px] font-bold rounded-full shadow-xs transition-all duration-200 group-hover:scale-110 ${
                  isBagActive
                    ...
                    : 'bg-brand-pink text-white group-hover:shadow-glow-pink'
                }`}
              >
                {itemCount}
              </span>
          ...
          <div ref={dropdownRef} className="relative">
            ...
            >
              ...
              {user?.isGuest && (
                <span
                  className="w-2 h-2 rounded-full bg-emerald-400 ring-2 ring-white"
                  title="Active Guest Mode"
                />
              )}
            </button>
