/**
 * Centralized pricing, discount, and shipping constants for Baby Step server.
 */
...
/**
 * Calculates discount, delivery charge, and grand total consistently for verified orders.
 */
